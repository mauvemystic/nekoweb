/* Welcome to the script file! Your 1st time here, you should update the basic info section to include your name and website/social media link (if desired). Most of the time, you will just come here to update the posts array. However, you can also edit or add your own scripts to do whatever you like! */
...
let blogName = "mauvemystic's musings";
let authorName = "mauvemystic";
let authorLink = "mauvemystic.nekoweb.org/"; // Enter your website, social media, etc. Some way for people to tell you they like your blog! (Leaving it empty is okay too)
...
/* UPDATE: as of version 1.3, you may omit the date if you would like. But if you use a date it must still follow that format. */

/* 3LEGGED'S TAGGING SYSTEM:
To make use of tags in your blog posts, add them to the end of the post array - ensuring that you leave a "", between tags and the post link for special character encoding (see examples below). 
After this point, tags can be in any order, are case-sensitive, and shouldn't contain spaces or special characters.
*/

let postsArray = [
//[ "posts/2020-11-10-HTML-cheat-sheet.html", encodeURI( 'Spéci@l "Character\'s" Examp|e' ), "general" ],
[ "posts/2025-07-27-july-2025-highlights.html", "july '25 highlights", "personal", "monthly" ],
[ "posts/2025-06-30-june-2025-highlights.html", "june '25 highlights", "personal", "monthly" ],
[ "posts/2025-06-30-may-2025-highlights.html", "may '25 highlights", "personal", "monthly" ],
[ "posts/2025-05-30-may-new-moon-reading.html","may new moon reading", "tarot", "readings", "personal" ],
[ "posts/2025-05-01-april-new-moon-reading.html","april new moon reading", "tarot", "readings", "personal" ],
[ "posts/2025-04-12-april-full-moon-reading.html","april full moon reading", "tarot", "readings", "personal" ],
[ "posts/2025-04-07-mental-checkin.html","mental checkin", "emotional",  "personal" ],
[ "posts/2025-03-11-In-A-Rut.html", "in a rut", "personal",  "emotional" ],
[ "posts/2025-03-02-Welcome.html", "welcome", "personal" ],
...
let headerHTML = '<ul> <li><button onclick="darkmode()">dark mode</button></li>' +
        '<li><button onclick="lightmode()">light mode</button></li>' + '<br><li><a href="' + relativePath + '/index.html">home</a></li>' + 
'<li><a href="' + relativePath + '/archive.html">archive</a></li>' +
'<li><a href="' + relativePath + '/about.html">about</a></li>' +
'<li><a href="https://mauvemystic.nekoweb.org/">the main island</a></li> </ul>';


//Write the Footer HTML, which has information about the blog.
let footerHTML = "<hr><p>" + blogName + " are written by <a href='" + "/" + "'>" + authorName + "</a>.</p>";
  ...
  if (  postDateFormat.test ( postsArray[currentIndex][0].slice( 6,17 ) ) ) {
	...
	for (i=2;i<postsArray[currentIndex].length;i++) {
	  console.log(postsArray[currentIndex][i]);
		postTagsHTML += '<a href="/blog/tags/' + postsArray[currentIndex][i] + '">' + postsArray[currentIndex][i] + '</a>, ';
	}
...
let recentPostListHTML = "<h2>My Recent Posts:</h2><ul>";
